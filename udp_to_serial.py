...
class TCodeWSServer:
    ...
    def _schedule_broadcast(self, message):
        for client in self.clients:
            task = self.loop.create_task(self._send_to_client(client, message))
    ...
    def broadcast(self, message):
        ...
        with `loop.call_soon_threadsafe(func)` which directly creates tasks.
        This removes intermediate coroutine scheduling overhead, improving throughput for fire-and-forget messages.
        """
