...
class TCodeWSServer:
    ...
    async def _send_safe(self, client, message):
        try:
            ...
            pass # Discard exceptions from disconnected clients; handler will remove them
    ...
    def broadcast(self, message):
        ...
        ⚡ Optimized: Using `call_soon_threadsafe` and direct task creation instead of
        `run_coroutine_threadsafe` and `gather` to avoid intermediate coroutine overhead
        during high-frequency fire-and-forget broadcasting.
        """
