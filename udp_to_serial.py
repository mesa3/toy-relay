...
class TCodeWSServer:
    ...
    def broadcast(self, message):
        ...
        ⚡ Bolt: Uses call_soon_threadsafe + create_task instead of run_coroutine_threadsafe + gather
        to avoid coroutine scheduling overhead for fire-and-forget messages.
        """
