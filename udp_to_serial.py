...
class TCodeWSServer:
    ...
    def broadcast(self, message):
        ...
        with direct `create_task` fire-and-forget logic using `call_soon_threadsafe`.
        This eliminates intermediate coroutine scheduling overhead, improving throughput.
        """
