...
class TCodeWSServer:
    ...
    def broadcast(self, message):
        ...
        with `loop.call_soon_threadsafe(func)` which directly uses `loop.create_task()` for fire-and-forget
        broadcasting. This removes intermediate coroutine scheduling overhead.
        """
