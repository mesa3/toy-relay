...
class TCodeWSServer:
    ...
    def broadcast(self, message):
        ...
        ⚡ Optimized: Using call_soon_threadsafe instead of run_coroutine_threadsafe
        removes intermediate coroutine scheduling overhead, improving fire-and-forget
        throughput for WebSocket broadcasting.
        """
