...
class TCodeWSServer:
    ...
    def broadcast(self, message):
        ...
        ⚡ Optimized: Replaced asyncio.run_coroutine_threadsafe with
        loop.call_soon_threadsafe and direct task creation to remove
        intermediate coroutine scheduling overhead.
        """
