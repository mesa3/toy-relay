...
class TCodeWSServer:
    ...
    def broadcast(self, message):
        ...
        ⚡ Bolt: Uses loop.call_soon_threadsafe with create_task directly to avoid
        asyncio.run_coroutine_threadsafe scheduling overhead for high-frequency fire-and-forget messages.
        """
