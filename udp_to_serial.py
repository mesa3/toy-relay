...
class TCodeWSServer:
    ...
    def broadcast(self, message):
        ...
        with direct scheduling (`loop.call_soon_threadsafe`) and task creation (`loop.create_task`).
        This removes intermediate coroutine scheduling overhead, significantly improving
        throughput for fire-and-forget messages.
        """
