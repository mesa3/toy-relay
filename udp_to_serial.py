...
class TCodeWSServer:
    ...
    def broadcast(self, message):
        ...
        ⚡ Optimized: Replaced gathering of coroutines via threadsafe scheduling
        with direct threadsafe background task creation, eliminating intermediate
        coroutine setup overhead per broadcast.
        """
